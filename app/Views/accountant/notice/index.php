                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><a href="<?=base_url(ACCO."/notice3")?>" class="btn btn-primary">
                                            ...
                                            <tbody>
                                                <?php foreach ($noticeslist as $key => $row): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url(ACCO . 'view_notice3/' . $row["id"]) ?>" class="btn btn-warning">
    <i class="bi bi-check-circle"></i>
</a>
                                                            <a href="<?= base_url(ACCO . 'edit_notice3/' . $row["id"]) ?>" class="btn btn-primary">
    ...
    // Handle delete button click
     $('.delete-button').on('click', function() {
        ...
        if (confirm('Are you sure you want to delete?')) {
            $.ajax({
                url: '<?= base_url(ACCO . "delete_notice3/") ?>' + id,
                type: 'GET',
                dataType: "json",
