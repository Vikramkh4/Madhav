...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="<?=ACCO?>" class="brand-link"> <!--begin::Brand Image--> <img src="<?=base_url(getAppDetails(1,"logo"))?>" alt="<?=getAppDetails(1,'name')?>" class="brand-image opacity-75 shadow"> <!--end::Brand Image--> <!--begin::Brand Text--> <span class="brand-text fw-light"><?=getAppDetails(1,"name")?></span> <!--end::Brand Text--> </a> <!--end::Brand Link--> </div> <!--end::Sidebar Brand--> <!--begin::Sidebar Wrapper-->
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <!--        <li class="nav-item"> <a href="<?=base_url(ACCO."/invoice")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>-->
                        <!--                <p>Invoice List</p>-->
                        <!--            </a> </li>-->
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-person-circle"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="<?=base_url(ACCO."/notice_table3")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Notice List</p>
                                    </a> </li>
                       ...
                       <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-pen-fill"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="<?=base_url(ACCO."/add_complain")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Add  Category</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="<?=base_url(ACCO."/complaincategory_table")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Category List</p>
                                    </a> </li>
                                    
                                 <li class="nav-item"> <a href="<?=base_url(ACCO."/complain_table")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Complains</p>
                                    </a> </li>    
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-person-circle"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item"> <a href="<?=base_url(ACCO."/Feetype")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Add Fee</p>
                                  </a>
                               </li>
                                <li class="nav-item"> <a href="<?=base_url(ACCO."/feetype_table")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Fee Lists</p>
                                    </a> </li>
                                    <li class="nav-item"> <a href="<?=base_url(ACCO."/feesgroup")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Add Fees Group</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="<?=base_url(ACCO."/feesgroup_table")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                         ...
                         <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-person-circle"></i>
                            ...
                            <ul class="nav nav-treeview">
                            <!--    <li class="nav-item"> <a href="<?=base_url(ACCO."/student")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>-->
                            <!--            <p>Add Student</p>-->
                            <!--        </a> </li>-->
                                <li class="nav-item"> <a href="<?=base_url(ACCO."/studenttable")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Student Lists</p>
                                    </a> </li>
                         ...
                         <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-person-circle"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="<?=base_url(ACCO."/session_table")?>" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Sessions Lists</p>
                                    </a> </li>
