                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <!--<h3 class="card-title"><a href="<?=base_url(ADMIN.'add_invoice')?>" class="btn btn-primary">-->
                                            ...
                                            <tbody>
                                                <?php foreach ($invoice as $key => $row): ?>
                                                    <tr>
                                                        ...
                                                        try{
                                                         $stu  =$StudentModel->find($row['student']);
                                                         $deeg = $DegreeModel->find($row['class']);
                                                         $studnet = $stu['name']; 
                                                         $gegree   =  $deeg['name'];
                                                         }catch(\Exception $e){
                                                        ...
                                                        <td><?=  $row['date']?></td>
                                                        <td>
                                                            <a href="<?= base_url(ADMIN . 'pay/' . $row["student"]) ?>" class="btn btn-warning">
                                                                        <i class="bi bi-cash" data-toggle="tooltip" title="Pay"></i>
                                                                    </a>
...
$(document).ready(function() {
    ...
    //         $.ajax({
    //             url: '<?= base_url(ADMIN . "deleteinvoice/") ?>' + id,
    //             type: 'GET',
    //             dataType: "json",
