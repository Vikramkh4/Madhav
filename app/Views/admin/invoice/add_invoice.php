            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= site_url(ADMIN . "save_invoice") ?>" method="post">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select12" id="student" name="student">
                                                    ...
                                                    <?php foreach ($students as $student): ?>
                                                        <option value="<?= $student['name'] ?>" <?= set_select('student', $student['name']) ?>><?= $student['name'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select12" id="degree" name="degree">
                                                    ...
                                                    <?php foreach ($degrees as $degree): ?>
                                                        <option value="<?= $degree['name'] ?>" <?= set_select('degree', $degree['name']) ?>><?= $degree['name'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
