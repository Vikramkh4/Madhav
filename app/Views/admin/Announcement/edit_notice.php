            ...
            <div class="col-md-12">
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= site_url(ADMIN . 'update_notice/' . $notice['id']) ?>" method="post" class="needs-validation" novalidate>
                            <!-- Title Field -->
        ...
        <div class="form-group">
                        ...
                        <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?= site_url(ADMIN . 'notice_table') ?>" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div><!-- /.card-body -->
                </div> <!-- /.card -->
