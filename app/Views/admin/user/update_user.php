            ...
            <div class="row">
                <div class="col-8 ">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                           <form action="<?= site_url(ADMIN."edit_save/$user[id]") ?>" method="post" enctype="multipart/form-data">
    <div class="card-body">
        <div class="mb-3">
        ...
        <div class="mb-3">
           <label for="profile_image" class="form-label">Profile Image</label>
            <input type="file" class="form-control" id="profile_image" name="image" accept="image/*" >
    
            <?php if (!empty($user['profile'])): ?>
                <img src="<?= base_url(USER_IMAGE_PATH.'/'.$user['profile']) ?>" alt="User Image" class="img-fluid" style="max-width: 100px;">
            <?php endif; ?>
        </div>
      ...
      <div class="mb-3">
        ...
        <option value="accoun" <?= getPermissionByUserId($user['id']) == "accoun" ? "selected" : "" ?>>Accountant</option>
          <option value="adnib" <?= getPermissionByUserId($user['id']) == "admin" ? "selected" : "" ?>>Admin</option>
            </select>       
        </div>
