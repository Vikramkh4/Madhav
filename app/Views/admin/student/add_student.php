c<?= $this->extend('admin/layout/base') ?>
            ...
            <div class="row">
                <div class="col-12 ">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
    <form action="<?= site_url(ADMIN . "save_student") ?>"  method="post" enctype="multipart/form-data">
    ...
    <div class="valid-feedback">Looks good!</div>
                ...
                <div class="col-md-3">
                        ...
                        <select class="form-control select22" id="category" name="category"  >
                            ...
                            <option value="General Cast" <?= set_select('category', 'General Cast') ?>>General</option>
   ...
   <div class="col-md-3">
    ...
    <div class="card-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="sign_of_student" class="form-control-label">Student Signature<span class='text-success text-sm'>*</span></label>
        ...
        <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <label for="snanthak_result_allyear" class="form-label">Snatak Result All Year</label>
                        <input type="file" class="form-control" id="snanthak_result_allyear" name="snanthak_result_allyear"  >
                        <div class="valid-feedback">Looks good!</div>
                    </div>
                    <div class="col-md-3">
                        <label for="tc" class="form-label">Transfer Certificate</label>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input style="margin-left:10px;" type="checkbox" class="form-check-input" id="non_criminal_report" name="non_criminal_report" <?= set_checkbox('non_criminal_report', '1') ?>>
                    </div>
                    <div class="col-md-3">
                        <label for="anti_raggin" class="form-label">Anti-Ragging</label>
                        <input style="margin-left:10px;" type="checkbox" class="form-check-input" id="anti_raggin" name="anti_raggin" <?= set_checkbox('anti_raggin', '1') ?>>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                ...
                <div id="partial-payment-container" style="display: none;">
                    <div class="partial-payment-row">
                        <input type="number" name="payment[]" placeholder="Enter amount" min="0.00" onclick="selectCheckbox(this)" oninput="deselectCheckbox(this)">
